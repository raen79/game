...
room_01_001 = {"name":"",                   # Name displayed on menus and while in the room
               ...
               "exits":{},                  # ***new*** exit key must be lower case! "open door" not "OPEN DOOR"***new*** Dictionary containing a command( this is now more flexibile and can be "open door" instead of "south") and the room key found in the current stages "rooms" dictionary. e.g "open door":"Room 15". Do not use long commands and do not use commands that could be generated by in room items "TAKE SWORD") 
