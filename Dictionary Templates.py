...
"animations":{"light attack":[""],"Heavy attack":[""],"Parry":[""],"Dodge":[""],"inaction":[""]},  # When a monster takes an action a random string will be selected from the list contained in the actions dictionary entry. e.g {"dodge":["The goblin attempts to dart out the way","the goblin tried to avoid the attack"]   
...
room_01_001 = {"name":"",                   # Name displayed on menus and while in the room
               ...
               "item_list":[],              # (List of item dictionary variables e.g. "item_list":sword_001,church_key001) Items "on the floor" of the room to be picked up or that have been dropped by the player 
               ...
               "exit_req_inv":[],           # Dictionary that contains matching keys to the room's exits. The value is the "name" value of an item that must be in the player's inventory. E.g {"OPEN DOOR":"Church key"}
               "exit_req_equ":[],           # Dictionary that contains matching keys to the room's exits. The value is the "name" value of an item that must be equiped by the player. E.g {"CHARGE GOBLINS":"Dagger"}
